...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ai_summary: Schema.Attribute.RichText;
    amenities: Schema.Attribute.Relation<'manyToMany', 'api::amenity.amenity'>;
    contact: Schema.Attribute.Component<'general.contact', true>;
    ...
    experiences_raw: Schema.Attribute.RichText;
    ...
    need_to_know: Schema.Attribute.RichText;
    opening_hours: Schema.Attribute.Text;
    photos: Schema.Attribute.Component<'general.photo', true>;
    place_id: Schema.Attribute.String;
    price_pp: Schema.Attribute.Integer;
    province: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rates: Schema.Attribute.Component<'general.rate', true>;
    ...
    unexpected: Schema.Attribute.Component<'general.unexpected', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
